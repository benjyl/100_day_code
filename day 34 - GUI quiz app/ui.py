...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.question_text = self.canvas.create_text(150, 125, width=280, text="Initial text", fill= "black", font=("Arial", 20, "italic"))
        self.canvas.grid(row=1, column=0, columnspan=2, pady=50)

        
        tick = PhotoImage(file="./images/true.png")
        self.tick_button = Button(image=tick, highlightthickness=0, command=self.press_true)
        self.tick_button.grid(row=2, column=0)
        
        cross = PhotoImage(file="./images/false.png")
        self.cross_button = Button(image=cross, highlightthickness=0, command=self.press_false)
